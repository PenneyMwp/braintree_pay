...
public class BraintreeFragment extends BrowserSwitchFragment {
    ...
    @SuppressWarnings("WeakerAccess")
    @VisibleForTesting
    static final String EXTRA_CONFIGURATION =
    ...
    public void onAttach(@NotNull Context context) {
        ...
        onAttach(Objects.requireNonNull(getActivity()));
    }
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        if (!isAdded()) {
            postCallback(new BraintreeException("BraintreeFragment is not attached" +
                    " to an Activity. Please ensure it " + "is attached and try again."));
        } else {
    ...
    @Override
    public void onBrowserSwitchResult(int requestCode,
        ...
        if (!mGoogleApiClient.isConnected() && !mGoogleApiClient.isConnecting()) {
            ...
            mGoogleApiClient.registerConnectionFailedListener(new OnConnectionFailedListener() {
                ...
                public void onConnectionFailed(@NotNull ConnectionResult connectionResult) {
                    postCallback(new GoogleApiClientException(ErrorType.ConnectionFailed,
