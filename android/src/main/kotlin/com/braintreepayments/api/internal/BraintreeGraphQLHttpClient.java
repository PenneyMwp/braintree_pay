...
import com.core.braintreepayments.api.Json;
...
import com.core.braintreepayments.api.internal.TLSSocketFactory;
...
public class BraintreeGraphQLHttpClient extends BraintreeApiHttpClient {
    ...
    private BraintreeGraphQLHttpClient(String baseUrl, String bearer, String apiVersion) {
        ...
        try {
            setSSLSocketFactory(new TLSSocketFactory(BraintreeGraphQLCertificate
                    .getCertInputStream()));
