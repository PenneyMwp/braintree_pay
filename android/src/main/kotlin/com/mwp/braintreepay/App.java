...
import com.mwp.braintreepay.internal.ApiClient;
import com.mwp.braintreepay.internal.ApiClientRequestInterceptor;
    ...
    public void onCreate() {
        ...
        if (BuildConfig.DEBUG) {
            StrictMode.ThreadPolicy.Builder threadPolicy = new StrictMode.ThreadPolicy.Builder()
                    ...
                    .detectNetwork()
                    .penaltyLog();
            StrictMode.VmPolicy.Builder vmPolicy = null;
