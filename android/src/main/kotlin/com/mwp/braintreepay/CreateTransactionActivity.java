...
import com.mwp.braintreepay.models.Transaction;
...
public class CreateTransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendNonceToServer((PaymentMethodNonce) getIntent()
                .getParcelableExtra(EXTRA_PAYMENT_METHOD_NONCE));
    }
    ...
    private void sendNonceToServer(PaymentMethodNonce nonce) {
        ...
        if (Settings.isThreeDSecureEnabled(this) && Settings.isThreeDSecureRequired(this)) {
            App.getApiClient(this).createTransaction(nonce.getNonce(),
            ...
            App.getApiClient(this).createTransaction(nonce.getNonce(), Settings.getMerchantAccountId(this),
                    callback);
        }
    }
